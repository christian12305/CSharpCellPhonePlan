 ...
 *          the number of phones, and a few options to calculate the
 *          monthly charge to the client.      
 */
...
{
    public partial class FamilyPlanForm : Form
    {
        public FamilyPlanForm() 
        {
            InitializeComponent();
        }
        ...
        //Updates the values with the calculations
        ...
        private void optionsChosen(out decimal optionsCost)
        {
            ...
            optionsCost = temp * Convert.ToDecimal(cboNumberPhones.SelectedItem);
        }
        ...
        private void modelChosen(out decimal phoneCost)
        {
            ...
            phoneCost *= Convert.ToDecimal(cboNumberPhones.SelectedItem);
        }
        ...
        //Event handeler for close operation.
